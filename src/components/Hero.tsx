...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center bg-hero-gradient overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(236,72,153,0.1)_0%,transparent_50%)]" />
      
      <div className="container mx-auto px-6 py-20 text-center relative z-10 bg-indigo-950">
        <div className="animate-fade-in bg-indigo-950">
          <div className="flex justify-center mb-8">
            <img src="/lovable-uploads/2ac94e5b-f5c3-401c-8f8b-246e5e2feec9.png" alt="V AI Interview Bot" className="w-24 h-24 animate-glow" />
          </div>
          
          <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-fuchsia-500 md:text-7xl">
            Master Your
            <span className="block text-fuchsia-500 text-6xl">Interview Skills</span>
          </h1>
          
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed text-fuchsia-500">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button variant="hero" size="lg" className="text-lg px-8 py-6" onClick={() => navigate("/interview")}>
              <PlayCircle className="mr-2 h-5 w-5" />
              Start Mock Interview
            </Button>
            <Button variant="outline" size="lg" className="text-lg px-8 py-6 border-muted-foreground text-foreground hover:bg-accent" onClick={() => navigate("/demo")}>
              View Demo
            </Button>
          </div>
