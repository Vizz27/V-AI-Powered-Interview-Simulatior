...
const HowItWorks = () => {
  ...
  return <section id="how-it-works" className="py-20 bg-indigo-950">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-50">
            How <span className="text-fuchsia-500">V</span> Works
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((step, index) => <div key={index} className="relative">
              <div className="bg-card-gradient rounded-2xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-300 text-center h-full">
                ...
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 bg-stone-950">
